...
{
  protected
    $rowFormat					= '<div class="control-group">%label%<div class="controls">%field%<span class="help-inline">%error%</span></div>%help% %hidden_fields%</div>',
    $errorRowFormat  			= '<div class="control-group error">%label%<div class="controls">%field%<span class="help-inline">%error%</span></div>%help% %hidden_fields%</div>',
