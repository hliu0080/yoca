...
class sfWidgetFormSchemaFormatterCustom extends sfWidgetFormSchemaFormatter
{
  protected
    ...
    $errorRowFormat  			= '<div class="control-group error">%label%<div class="controls">%field%<span class="help-inline">%error%</span><span class="help-block">%help%</span></div>%hidden_fields%</div>',
